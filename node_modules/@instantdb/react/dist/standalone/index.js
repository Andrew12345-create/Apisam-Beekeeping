      ...
      if (o && typeof o == "object" && a !== -1)
        throw r[0] === o ? new Error("Forbids circular reference") : new Error(`Forbids circular reference: ~/${i.slice(0, a).map((u, c) => {
          if (typeof u == "symbol")
            return `[${u.toString()}]`;
          const d = r[c];
          return typeof u == "object" && (d instanceof Map || d instanceof Set) ? Array.from(d.keys()).indexOf(u) : u;
        }).join("/")}`);
      r.push(o), i.push(e);
    } else
      r.push(o);
...
function Rs(t, e, n, r, i) {
  ...
  if (s.length < u.length) {
    ...
    if (c) {
      ...
      for (let d = u.length; s.length < d; d -= 1) {
...
function dt(t, e) {
  ...
  if (Array.isArray(e[0])) {
    ...
    if (!u)
      return null;
    i = (n = X(u, 2).find((d) => d[2] === a)) === null || n === void 0 ? void 0 : n[0];
  } else
    i = e[0];
  if (!i)
    return null;
  ...
  if (Array.isArray(s) && s.length === 2 && t.aev.get(s[0])) {
    ...
    if (!u)
      return null;
    const d = (r = X(u, 2).find((b) => b[2] === a)) === null || r === void 0 ? void 0 : r[0];
    if (!d)
      return null;
    const [f, l, p, ...y] = e;
    return [i, l, d, ...y];
...
function dn(t, e) {
  ...
  if (u) {
    for (const d of u.keys()) {
      ...
      ((n = f["forward-identity"]) === null || n === void 0 ? void 0 : n[1]) === s) && (oe(t.aev, [d, a]), oe(t.eav, [a, d]));
    }
    u.size === 0 && oe(t.eav, [a]);
  }
...
function Ri(t, e, n, r, i) {
  ...
  const [u, c] = a["forward-identity"], [d, f] = a["reverse-identity"], l = r + 1, p = s ? [
    t(c, r),
    a.id,
    t(f, l),
    rt("time")
...
function da(t, { etype: e, pageInfo: n, dq: r, form: i }) {
  ...
  d.sort(c === "asc" ? function(_, w) {
    return It(_, w, l == null ? void 0 : l["checked-data-type"]);
  } : function(_, w) {
...
function la(t, { etype: e, level: n, form: r, join: i, pageInfo: s }) {
  ...
  }), b = ((u = r.$) === null || u === void 0 ? void 0 : u.limit) || ((c = r.$) === null || c === void 0 ? void 0 : c.first) || ((d = r.$) === null || d === void 0 ? void 0 : d.last);
  if (b != null) {
    ...
    const _ = Object.entries(y);
    return _.length <= b ? y : Object.fromEntries(_.slice(0, b));
  }
  return y;
}
function ha(t, e) {
...
class Tn {
  ...
  _initMeta() {
    return de(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const o = (n = (e = this._meta.value) === null || e === void 0 ? void 0 : e.objects) !== null && n !== void 0 ? n : {}, a = s ?? {}, u = (r = a.objects) !== null && r !== void 0 ? r : {};
        this._meta.value = Object.assign(Object.assign({}, a), { objects: Object.assign(Object.assign({}, o), u) });
      } catch (i) {
  ...
  _preloadEntries(e) {
    return de(this, void 0, void 0, function* () {
      ...
      r.sort(([i, s], [o, a]) => a.updatedAt - s.updatedAt);
  ...
  _writeToStorage(e) {
    ...
    for (const p of this._pendingSaveKeys)
      p in this.currentValue ? u.push(p) : (a.push(p), delete o.objects[p]);
    for (const p of a) {
  ...
  _gc() {
    return de(this, void 0, void 0, function* () {
      ...
      a.sort(([l, p], [y, b]) => p.updatedAt - b.updatedAt);
      const u = a.filter(([l]) => !n.has(l));
      ...
      for (const [y, b] of Object.entries(r)) {
        ...
        if (_.lastAccessed) {
          const g = {
            ...
            size: (d = (c = (u = (a = _.result) === null || a === void 0 ? void 0 : a.store) === null || u === void 0 ? void 0 : u.triples) === null || c === void 0 ? void 0 : c.length) !== null && d !== void 0 ? d : 0
          };
          f[y] = g;
        }
        const w = n.put(_, y);
    ...
    return pe(this, void 0, void 0, function* () {
      ...
      return new Promise((n, r) => {
        ...
        o.onerror = (a) => {
          ...
          n(o.result.filter((u) => typeof u == "string"));
        };
      });
    });
  }
...
function su(t) {
  return ft(this, arguments, void 0, function* ({ apiURI: e, appId: n, path: r, file: i, refreshToken: s, contentType: o, contentDisposition: a }) {
    ...
    return a && (u["content-disposition"] = a), yield ue(`${e}/storage/upload`, {
      method: "PUT",
      headers: u,
      body: i
    });
...
class H {
  ...
  unique() {
    return new H(this.valueType, this.required, this.isIndexed, Object.assign(Object.assign({}, this.config), { unique: !0 }));
  }
  indexed() {
    return new H(this.valueType, this.required, !0, Object.assign(Object.assign({}, this.config), { indexed: !0 }));
  }
}
class Ut {
  constructor(e, n) {
  ...
  asType() {
    return new Ut(this.attrs, this.links);
  }
}
class Lt {
  constructor(e, n, r) {
...
const Kr = [
  ...
  switch (t) {
    ...
    case "$like":
    case "$ilike":
      if (u(t, "string", e), t === "$ilike" && !s.isIndexed)
  ...
  for (let d = 0; d < s.length - 1; d++) {
    ...
    if (!p) {
      ...
      throw new R(`Link '${f}' does not exist on entity '${o}' in dot notation path '${t}'. Available links: ${y.length > 0 ? y.join(", ") : "none"}`, i);
    }
    o = p.entityName;
  }
  const a = s[s.length - 1], u = r.entities[o];
  if (!u)
  ...
  for (const [i, s] of Object.entries(t)) {
    ...
    if (i === "id") {
      Ue(s, "id", new H("string", !1, !0), e, `${r}.id`);
      continue;
    }
    if (i.includes(".")) {
      yu(i, s, e, n, `${r}.${i}`);
  ...
  for (const o of Object.keys(t))
    if (o !== "$") {
      if (n && !(o in n.entities[e].links)) {
        const u = Object.keys(n.entities[e].links);
        throw new R(`Link '${o}' does not exist on entity '${e}'. Available links: ${u.length > 0 ? u.join(", ") : "none"}`, `${r}.${o}`);
      }
      const a = t[o];
...
const Hi = (t) => t.length > 0 ? t.join(", ") : "none", _u = (t, e) => new ie(`Entity '${t}' does not exist in schema. Available entities: ${Hi(e)}`), zr = {
  ...
  for (const r of n) {
    if (!r || typeof r != "object")
      throw new ie(`Transaction chunk must be an object, but received: ${typeof r}`);
    if (!Array.isArray(r.__ops))
      throw new ie(`Transaction chunk must have __ops array, but received: ${typeof r.__ops}`);
...
function Au(t, e) {
  ...
  for (const { action: a, triple: u } of e) {
    const [c, d, f] = u, l = (r = (n = t.attrs[d]) === null || n === void 0 ? void 0 : n["forward-identity"]) === null || r === void 0 ? void 0 : r[2];
    if (!l)
      continue;
    const p = (i = o[c]) !== null && i !== void 0 ? i : {};
    o[c] = p;
  ...
  for (const a of Object.keys(o)) {
    const { oldValue: u, newValue: c } = o[a];
    u === c && delete o[a];
  }
  return o;
}
...
function ku(t, e, n) {
  ...
  if (t.orderField === "serverCreatedAt") {
    n.sort(t.orderDirection === "asc" ? function(o, a) {
      return Xe(o.entity.id, o.serverCreatedAt, a.entity.id, a.serverCreatedAt, r);
    } : function(o, a) {
      return Xe(a.entity.id, a.serverCreatedAt, o.entity.id, o.serverCreatedAt, r);
    });
    return;
  }
  const i = t.orderField;
  n.sort(t.orderDirection === "asc" ? function(o, a) {
    return Xe(o.entity.id, o.entity[i], a.entity.id, a.entity[i], r);
  } : function(o, a) {
    return Xe(a.entity.id, a.entity[i], o.entity.id, o.entity[i], r);
  });
}
var ve;
(function(t) {
...
class Cu {
  ...
  initSubscription(e, n, r) {
    return Qr(this, void 0, void 0, function* () {
      ...
      if (u && u.state && u.state.txId) {
        this.sendResync(u, u.state, u.state.txId), !((i = u.values) === null || i === void 0) && i.entities && r && r({
          type: ve.LoadFromStorage,
          data: wt(u, (s = u.values) === null || s === void 0 ? void 0 : s.entities)
        });
        return;
      }
      const c = Object.keys(e)[0], d = ((a = (o = e[c]) === null || o === void 0 ? void 0 : o.$) === null || a === void 0 ? void 0 : a.order) || { serverCreatedAt: "asc" }, [f, l] = Object.entries(d)[0];
  ...
  onStartSyncOk(e) {
    const n = e["subscription-id"], r = e.q, i = z(r);
  ...
  onSyncLoadBatch(e) {
    ...
    const o = [], a = this.subs.currentValue[s];
    if (!a) {
      this.log.error("Missing sub for hash", s, e);
      return;
    }
    const u = (n = a.values) !== null && n !== void 0 ? n : {
      entities: [],
    ...
    this.subs.updateInPlace((d) => {
      d[s] = a, d[s].updatedAt = Date.now();
    }), a.values && this.notifyCbs(s, {
      type: ve.InitialSyncBatch,
      data: wt(a, a.values.entities),
      batch: o
    });
  }
  onSyncInitFinish(e) {
    ...
    this.subs.updateInPlace((o) => {
      ...
      u.txId = e["tx-id"], a.updatedAt = Date.now();
    });
    const s = this.subs.currentValue[i];
    s && this.notifyCbs(i, {
      type: ve.InitialSyncComplete,
      data: wt(s, ((n = s.values) === null || n === void 0 ? void 0 : n.entities) || [])
    });
  }
  onSyncUpdateTriples(e) {
    ...
    const a = this.subs.currentValue[o];
    if (!a) {
    ...
    for (const c of e.txes) {
      ...
      const l = (r = a.values) !== null && r !== void 0 ? r : {
        entities: [],
        attrs: this.createStore([]).attrs
      }, p = l.entities;
      a.values = l;
        ...
        for (let E = 0; E < p.length; E++) {
          ...
          if (ao(S.store, g)) {
            ...
            I ? (y.push({
              ...
              newEntity: I,
              changedFields: x || {}
            }), S.entity = I) : d.push(E), delete f[g];
            continue e;
          }
        }
      const b = [];
  ...
  onStartSyncError(e) {
    const n = z(e["original-event"].q), r = {
...
class qu {
    ...
    if (this._isOnline = !0, this._isShutdown = !1, this.status = le.CONNECTING, this.queryCbs = {}, this.queryOnceDfds = {}, this.authCbs = [], this.attrsCbs = [], this.mutationErrorCbs = [], this.connectionStatusCbs = [], this.mutationDeferredStore = /* @__PURE__ */ new Map(), this._reconnectTimeoutId = null, this._reconnectTimeoutMs = 0, this._transportType = "ws", this._wsOk = null, this._localIdPromises = {}, this._errorMessage = null, this._oauthCallbackResponse = null, this._linkIndex = null, this._rooms = {}, this._roomsPendingLeave = {}, this._presence = {}, this._broadcastQueue = [], this._broadcastSubs = {}, this._currentUserCached = { isLoading: !0, error: void 0, user: void 0 }, this._beforeUnloadCbs = [], this._dataForQueryCache = {}, this._inFlightMutationEventIds = /* @__PURE__ */ new Set(), this._onMergeKv = (c, d, f) => {
      ...
      switch (c) {
        case "pendingMutations": {
          ...
          return (d ? this._rewriteMutationsSorted(this.attrs, d) : []).forEach(([g, m]) => {
            var E;
            !(!((E = f == null ? void 0 : f.pendingMutations) === null || E === void 0) && E.has(g)) && !m["tx-id"] && this._sendMutation(g, m);
          }), _;
        }
        default:
          return f || d;
      ...
      y != null && y.data && (this._dataForQueryCache[c] = y, !Ot(y.data, p) && l.forEach((b) => b.cb(y.data)));
      ...
      const f = K(), l = [...this._pendingMutations().values()], p = Math.max(0, ...l.map((_) => _.order || 0)) + 1, y = {
        op: "transact",
        "tx-steps": c,
        created: Date.now(),
        error: d,
      ...
      this._log.info("[socket][open]", this._transport.id), this._setStatus(le.OPENED), this.getCurrentUser().then((f) => {
        var l;
        this._trySend(K(), {
          op: "init",
      ...
      typeof BroadcastChannel == "function" && (this._broadcastChannel = new BroadcastChannel("@instantdb"), this._broadcastChannel.addEventListener("message", (c) => F(this, void 0, void 0, function* () {
        var d;
        try {
        ...
        this._isOnline = c, this._startSocket(), r.listen((d) => {
          d !== this._isOnline && (this._log.info("[network] online =", d), this._isOnline = d, this._isOnline ? this._startSocket() : (this._log.info("Changing status from", this.status, "to", le.CLOSED), this._setStatus(le.CLOSED)));
        });
  ...
  _initStorage(e) {
    ...
    }, this.kv.waitForKeyToLoad("pendingMutations"), this.kv.waitForKeyToLoad(Qe), this._beforeUnloadCbs.push(() => {
  ...
  _handleReceive(e, n) {
    ...
    switch (Jr[n.op] || this._log.info("[receive]", e, n.op, n), n.op) {
      ...
      case "refresh-ok": {
        ...
        w.forEach(({ hash: g, q: m, store: E, pageInfo: S, aggregate: I }) => {
          this.querySubs.updateInPlace((x) => {
            if (!x[g]) {
              this._log.error("Missing value in querySubs", { hash: g, q: m });
              return;
            }
            x[g].result = { store: E, pageInfo: S, aggregate: I, processedTxId: y };
          });
      ...
      case "transact-ok": {
        ...
        const _ = b["tx-steps"].filter(([w, ...g]) => w === "add-attr").map(([w, g]) => g).concat(Object.values(this.attrs));
        this._setAttrs(_), this._finishTransaction("synced", l), this._cleanupPendingMutationsTimeout();
        break;
      }
      case "patch-presence": {
        const l = n["room-id"];
  ...
  _handleReceiveError(e) {
    ...
    if (!((n = e["original-event"]) === null || n === void 0) && n.hasOwnProperty("q") && ((r = e["original-event"]) === null || r === void 0 ? void 0 : r.op) === "add-query") {
      const y = (i = e["original-event"]) === null || i === void 0 ? void 0 : i.q, b = z(y);
      this.notifyQueryError(z(y), f), this.notifyQueryOnceError(y, b, c, f);
      return;
    }
    if (((s = e["original-event"]) === null || s === void 0 ? void 0 : s.op) === "init") {
      ...
      this._setStatus(le.ERRORED, f), this.notifyAll();
      return;
    }
    if (((a = e["original-event"]) === null || a === void 0 ? void 0 : a.op) === "resync-table") {
      this._syncTable.onResyncError(e);
      return;
    }
    if (((u = e["original-event"]) === null || u === void 0 ? void 0 : u.op) === "start-sync") {
...
`, e.hint);
  ...
  _rewriteMutations(e, n, r) {
    ...
    const u = (d, f) => {
      ...
      for (const p of d) {
        ...
        if (y === "add-attr") {
          const [_, w] = p, g = i(w);
          if (g && w.id !== g.id) {
            o.attrIdMap[w.id] = g.id, a = !0;
            continue;
          }
          if (w["value-type"] === "ref") {
            const m = s(w);
            if (m) {
              o.attrIdMap[w.id] = m.id, o.refSwapAttrIds.add(w.id), a = !0;
              continue;
            }
          }
        }
    ...
    for (const [d, f] of n.entries())
      c.set(d, Object.assign(Object.assign({}, f), { "tx-steps": u(f["tx-steps"], f["tx-id"]) }));
    return a ? c : n;
  }
  ...
  optimisticAttrs() {
    var e;
    const n = [...this._pendingMutations().values()].flatMap((a) => a["tx-steps"]), r = new Set(n.filter(([a, u]) => a === "delete-attr").map(([a, u]) => u)), i = [];
    for (const [a, u] of n)
      if (a === "add-attr")
        i.push(u);
  ...
  _sendMutation(e, n) {
    ...
    if (this.status !== le.AUTHENTICATED) {
  ...
  _trySendAuthed(...e) {
    this.status === le.AUTHENTICATED && this._trySend(...e);
  }
  _trySend(e, n, r) {
    ...
    return F(this, void 0, void 0, function* () {
      ...
      try {
        const u = yield this._getCurrentUser(), c = (u == null ? void 0 : u.type) === "guest", { user: d } = yield Dr({
          ...
          appId: this.config.appId,
          code: a,
          refreshToken: c ? u.refresh_token : void 0
        });
  ...
  setCurrentUser(e) {
    return F(this, void 0, void 0, function* () {
      this.kv.updateInPlace((n) => {
        n[Qe] = e;
      }), yield this.kv.waitForKeyToLoad(Qe);
    });
  }
  ...
  _getCurrentUser() {
    return F(this, void 0, void 0, function* () {
      const e = yield this.kv.waitForKeyToLoad(Qe);
  ...
  subscribePresence(e, n, r, i) {
    ...
    return this._presence[n] = this._presence[n] || {}, this._presence[n].handlers = this._presence[n].handlers || [], this._presence[n].handlers.push(o), this._notifyPresenceSub(n, o), () => {
      var a, u, c;
      this._presence[n].handlers = (c = (u = (a = this._presence[n]) === null || a === void 0 ? void 0 : a.handlers) === null || u === void 0 ? void 0 : u.filter((d) => d !== o)) !== null && c !== void 0 ? c : [], s();
    };
  }
  ...
  _patchPresencePeers(e, n) {
    ...
    let a = Object.fromEntries(Object.entries(o).map(([c, d]) => [c, { data: d }]));
  ...
  _notifyBroadcastSubs(e, n, r) {
    ...
    (o = (s = (i = this._broadcastSubs) === null || i === void 0 ? void 0 : i[e]) === null || s === void 0 ? void 0 : s[n]) === null || o === void 0 || o.forEach((a) => {
      var u, c, d, f, l, p;
      const y = (u = r.data) === null || u === void 0 ? void 0 : u.data, b = r.data["peer-id"] === this._sessionId ? (d = (c = this._presence[e]) === null || c === void 0 ? void 0 : c.result) === null || d === void 0 ? void 0 : d.user : (p = (l = (f = this._presence[e]) === null || f === void 0 ? void 0 : f.result) === null || l === void 0 ? void 0 : l.peers) === null || p === void 0 ? void 0 : p[r.data["peer-id"]];
      return a(y, b);
    });
  }
  // --------
...
function yc() {
  ...
  function o(a, u, c) {
    ...
    for (d in u) r.call(u, d) && !s.hasOwnProperty(d) && (f[d] = u[d]);
    if (a && a.defaultProps) for (d in u = a.defaultProps, u) f[d] === void 0 && (f[d] = u[d]);
...
function bc() {
  ...
  return t.NODE_ENV !== "production" && function() {
    ...
    function E(h, T, v) {
      {
        var O = g.ReactDebugCurrentFrame, P = O.getStackAddendum();
        P !== "" && (T += "%s", v = v.concat([P]));
        var M = v.map(function(C) {
          return String(C);
        });
        M.unshift("Warning: " + T), Function.prototype.apply.call(console[h], console, M);
      }
    }
    var S = !1, I = !1, x = !1, B = !1, Ve = !1, lt;
    lt = Symbol.for("react.module.reference");
    function Ft(h) {
      return !!(typeof h == "string" || typeof h == "function" || h === i || h === o || Ve || h === s || h === d || h === f || B || h === y || S || I || x || typeof h == "object" && h !== null && (h.$$typeof === p || h.$$typeof === l || h.$$typeof === a || h.$$typeof === u || h.$$typeof === c || // This needs to include all possible module reference object
    ...
    function ce(h) {
      ...
      if (typeof h == "object")
        switch (h.$$typeof) {
          case u:
            var T = h;
            return ht(T) + ".Consumer";
          case a:
            var v = h;
            return ht(v._context) + ".Provider";
          case c:
            return Nt(h, h.render, "ForwardRef");
          case l:
            var O = h.displayName || null;
            return O !== null ? O : ce(h.type) || "Memo";
          case p: {
            var P = h, M = P._payload, C = P._init;
            try {
              return ce(C(M));
            } catch {
              return null;
    ...
    var Kt = g.ReactCurrentDispatcher, qt;
    function pt(h, T, v) {
      {
        if (qt === void 0)
          try {
...
`), G = O.stack.split(`
`), D = j.length - 1, L = G.length - 1; D >= 1 && L >= 0 && j[D] !== G[L]; )
            L--;
          for (; D >= 1 && L >= 0; D--, L--)
            if (j[D] !== G[L]) {
              if (D !== 1 || L !== 1)
...
` + j[D].replace(" at new ", " at ");
                    return h.displayName && re.includes("<anonymous>") && (re = re.replace("<anonymous>", h.displayName)), typeof h == "function" && yt.set(h, re), re;
                  }
                while (D >= 1 && L >= 0);
              break;
            }
    ...
    function bt(h, T, v) {
      ...
      if (typeof h == "object")
        switch (h.$$typeof) {
          ...
          case p: {
            var O = h, P = O._payload, M = O._init;
            try {
              return bt(M(P), T, v);
            } catch {
            }
          ...
          if (M(h, C)) {
            ...
            try {
              if (typeof h[C] != "function") {
                var G = Error((O || "React class") + ": " + v + " type `" + C + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof h[C] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw G.name = "Invariant Violation", G;
              }
              j = h[C](T, C, O, v, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (D) {
              j = D;
            }
    ...
    function ws(h) {
      {
        for (var T = Object.keys(h.props), v = 0; v < T.length; v++) {
          var O = T[v];
          if (O !== "children" && O !== "key") {
            Pe(h), m("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", O), Pe(null);
            break;
          }
        }
...
function Oc(t, e = {}) {
  ...
  je(() => t.core._reactor.subscribePresence(t.type, t.id, e, (c) => {
    s(c);
...
function Ac(t, e, n = {}) {
  ...
  }, [n == null ? void 0 : n.writeOnly, i]), o = ge((d) => {
    var f;
  ...
  }, [t.type, t.id, e, n == null ? void 0 : n.timeout, r]), a = ge((d) => {
...
function Ic(t) {
  ...
  function f(b) {
    ...
    const _ = b.indexOf(":");
    if (_ !== -1) {
      const w = b.slice(0, _), g = b[_ + 1] === " " ? 2 : 1, m = b.slice(_ + g);
      l(w, m, b);
      return;
    }
    l(b, "", b);
...
`) ? u.slice(0, -1) : u
  ...
  function y(b = {}) {
    s && b.consume && f(s), o = !0, a = void 0, u = "", c = "", s = "";
  }
...
function Mc(t) {
  ...
  let n = "", r = 0;
  for (; r < t.length; ) {
    const i = t.indexOf("\r", r), s = t.indexOf(`
`, r);
    let o = -1;
    if (i !== -1 && s !== -1 ? o = Math.min(i, s) : i !== -1 ? o = i : s !== -1 && (o = s), o === -1) {
      n = t.slice(r);
      break;
    } else {
      const a = t.slice(r, o);
...
class si extends Event {
  ...
  constructor(e, n) {
    var r, i;
    super(e), this.code = (r = n == null ? void 0 : n.code) != null ? r : void 0, this.message = (i = n == null ? void 0 : n.message) != null ? i : void 0;
  }
  /**
...
class jt extends EventTarget {
  constructor(e, n) {
    ...
    super(), N(this, se), this.CONNECTING = 0, this.OPEN = 1, this.CLOSED = 2, N(this, J), N(this, Oe), N(this, Re), N(this, At), N(this, Rt), N(this, st), N(this, De), N(this, ot, null), N(this, _e), N(this, xe), N(this, Le, null), N(this, $e, null), N(this, et, null), N(this, En, async (s) => {
      ...
      if (c === 204) {
        he(this, se, tt).call(this, "Server sent HTTP 204, not reconnecting", 204), this.close();
        return;
      }
      if (u ? $(this, Re, new URL(s.url)) : $(this, Re, void 0), c !== 200) {
        he(this, se, tt).call(this, `Non-200 status code (${c})`, c);
        return;
      }
      if (!(d.get("content-type") || "").startsWith("text/event-stream")) {
        he(this, se, tt).call(this, 'Invalid content type, expected "text/event-stream"', c);
        return;
      }
      ...
      if ((o = A(this, et)) == null || o.call(this, f), this.dispatchEvent(f), typeof a != "object" || !a || !("getReader" in a)) {
        he(this, se, tt).call(this, "Invalid response body, expected a web ReadableStream", c), this.close();
        return;
      }
      ...
      const o = new MessageEvent(s.event || "message", {
        data: s.data,
        origin: A(this, Re) ? A(this, Re).origin : A(this, Oe).origin,
        lastEventId: s.id || ""
      });
   ...
   */
  close() {
    A(this, De) && clearTimeout(A(this, De)), A(this, J) !== this.CLOSED && (A(this, _e) && A(this, _e).abort(), $(this, J, this.CLOSED), $(this, _e, void 0));
  }
}
J = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), Re = /* @__PURE__ */ new WeakMap(), At = /* @__PURE__ */ new WeakMap(), Rt = /* @__PURE__ */ new WeakMap(), st = /* @__PURE__ */ new WeakMap(), De = /* @__PURE__ */ new WeakMap(), ot = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakSet(), /**
...
function zc({
  ...
  function p(g, m) {
    const E = m.clientX, S = m.clientY, I = (E - g.left) / g.width * 100, x = (S - g.top) / g.height * 100;
    f.publishPresence({
      [d]: {
        x: E,
        y: S,
      ...
      children: [
        /* @__PURE__ */ W.jsxs(
          "g",
          {
            ...
            children: [
              /* @__PURE__ */ W.jsx("path", { d: "m12 24.4219v-16.015l11.591 11.619h-6.781l-.411.124z" }),
              /* @__PURE__ */ W.jsx("path", { d: "m21.0845 25.0962-3.605 1.535-4.682-11.089 3.686-1.553z" })
            ]
          }
        ),
        /* @__PURE__ */ W.jsxs(
        ...
        /* @__PURE__ */ W.jsxs(
          "g",
          {
            ...
            transform: "matrix(1, 0, 0, 1, -11.999999046325684, -8.406899452209473)",
            children: [
              /* @__PURE__ */ W.jsx("path", { d: "m19.751 24.4155-1.844.774-3.1-7.374 1.841-.775z" }),
              /* @__PURE__ */ W.jsx("path", { d: "m13 10.814v11.188l2.969-2.866.428-.139h4.768z" })
            ]
          }
        )
      ]
