...
function createObjectAttr(schema, etype, label, props) {
    const schemaObjectProps = schema
        ...
        : null;
    const attrId = (0, uuid_ts_1.default)();
    const fwdIdentId = (0, uuid_ts_1.default)();
...
function refPropsFromSchema(schema, etype, label) {
    ...
    return {
        'forward-identity': [(0, uuid_ts_1.default)(), forward.on, forward.label],
        'reverse-identity': [(0, uuid_ts_1.default)(), reverse.on, reverse.label],
...
function createRefAttr(schema, etype, label, props) {
    const schemaRefProps = schema
        ...
        : null;
    const attrId = (0, uuid_ts_1.default)();
    const fwdIdent = [(0, uuid_ts_1.default)(), etype, label];
    const revIdent = [(0, uuid_ts_1.default)(), label, etype];
